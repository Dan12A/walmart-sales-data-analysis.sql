THIS QUERY DATA WAS GOTTEN FROM WALMART, THE QUERY SHOWS AN INDEPTH UNDERSTANDING OF WHAT GOES ON IN WALMART DAY TO DAY BUSINESS ACTIVTES 
AND ALSO GIVES CRUCIAL INFORMATION ON HOW THEY CAN IMPROVE USING INFORMATION SUCH AS,Which time of the day do customers give most ratings?,
what is the most common product line, what product line had the largesr revenue, What is the city with the largest revenue; AND SO ON
THESE ARE FEW OF THE INDEPTH INFORMATION GOTTEN. THIS DATA WAS QUERIED USING MYSQL.
